...
main(int argc, char *const *argv)
{
    ...
    //     &ngx_openssl_module,						// NGX_CORE_MODULE
    ...
    //     &ngx_http_gzip_static_module,			// NGX_HTTP_MODULE
    ...
    //     &ngx_http_ssl_module,					// NGX_HTTP_MODULE
    ...
    //     &ngx_http_flv_module,					// NGX_HTTP_MODULE
	...
	//     NULL
	// }; }}}
	// 对模块进行编号，初始化模块 index 域
    for (i = 0; ngx_modules[i]; i++) {
        ngx_modules[i]->index = ngx_max_module++;
    }

	// 全部初始化工作，包括时间、内存池、配置文件、共享内存
	//     、监听连接数组、CORE 模块配置文件的创建与初始化、所有模块的初始化，
	// 以及配置及log文件创建、连接开启监听
