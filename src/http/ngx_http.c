...
// 将 ngx_http_request_t 转换为请求头回调函数
ngx_int_t  (*ngx_http_top_header_filter) (ngx_http_request_t *r);
// 将 ngx_http_request_t 转换为请求包体回调函数
